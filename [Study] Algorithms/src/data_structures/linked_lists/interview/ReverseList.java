...
public class ReverseList
{
	...
	public static <T> Node<T> reverseIteratively(Node<T> head)
	{
		...
		while (current != null)
		{
			...
			current = current.getNext(); // advance the current loop pointer one past the head
			temp.setNext(newHead); // assign the next pointer of our new head to the previous head pointer
